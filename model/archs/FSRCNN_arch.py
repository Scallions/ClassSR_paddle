...
class FSRCNN_net(nn.Layer):
    def __init__(self, input_channels, upscale, d=64, s=12, m=4):
        ...
        self.body_conv = paddle.nn.Sequential(*self.layers)

        # Deconvolution
        self.tail_conv = nn.Conv2DTranspose(in_channels=d, out_channels=input_channels, kernel_size=9,
